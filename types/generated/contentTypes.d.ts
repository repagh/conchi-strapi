...
export interface ApiAlumnoAlumno extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Appellido: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    identidad: Schema.Attribute.UID;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::alumno.alumno'
...
export interface ApiCursoCurso extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    idcurso: Schema.Attribute.UID;
    Imagen: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    instancia_cursos: Schema.Attribute.Relation<
      'oneToMany',
      'api::fecha.fecha'
    >;
    ...
    Nivel: Schema.Attribute.Enumeration<
      ['A1', 'A2', 'B1', 'B2', 'C1', 'C2', 'A1-C2']
    >;
    publishedAt: Schema.Attribute.DateTime;
    Simbolito: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiFechaFecha extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    fechas: Schema.Attribute.Component<'shared.fechas10', true>;
    fechasid: Schema.Attribute.UID;
    ...
    publishedAt: Schema.Attribute.DateTime;
    subscripcions: Schema.Attribute.Relation<
      'oneToMany',
      'api::subscripcion.subscripcion'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSubscripcionSubscripcion
  extends Struct.CollectionTypeSchema {
  collectionName: 'subscripcions';
  info: {
    description: '';
    displayName: 'Subscripcion';
    pluralName: 'subscripcions';
    singularName: 'subscripcion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    instancia_curso: Schema.Attribute.Relation<'oneToOne', 'api::fecha.fecha'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::subscripcion.subscripcion'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::subscripcion.subscripcion': ApiSubscripcionSubscripcion;
